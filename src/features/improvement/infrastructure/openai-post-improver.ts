        ...
        "https://api.openai.com/v1/responses",
        {
          ...
          body: JSON.stringify({
            ...
            instructions: [
              ...
              "Use all eight rubric criteria, weights, current levels, and explanations to revise the draft. Prioritize weak, high-impact dimensions while preserving existing strengths. The scores are coarse feedback, not targets to game.",
              "For a whole-post action, make the strongest useful overall revision supported by the draft. Improve the central point, opening, concrete detail, structure, and ending where appropriate. A broad rewrite is allowed when it preserves the author's meaning.",
              "If a much stronger post requires a fact, example, or personal experience absent from the draft, do not invent it. Make the best supported revision or return no-safe-change with the specific missing information in reason.",
            ...
            input: JSON.stringify({
              ...
              strongestDimension: context.strongestDimension,
              weakestDimension: context.weakestDimension,
              focus: context.focus,
